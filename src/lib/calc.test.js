...
describe('buildInvoiceDispatches — grouping, de-duplication and what #193 still owes', () => {
  ...
  it('carries the raw customer name and no ship-to state — #193 has not landed yet', () => {
    const out = buildZoho([zohoRow()])
