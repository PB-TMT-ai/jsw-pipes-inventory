...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/jsw-pipes-inventory/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/user/jsw-pipes-inventory/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/user/jsw-pipes-inventory/.claude/commands/gsd
AGENTS_DIR=/home/user/jsw-pipes-inventory/.claude/agents
```
...
<execution_context>
Surface state file: `/home/user/jsw-pipes-inventory/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/user/jsw-pipes-inventory/.claude/skills/.gsd-profile`
Engine module: `/home/user/jsw-pipes-inventory/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/jsw-pipes-inventory/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
