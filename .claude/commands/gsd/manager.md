...
<execution_context>
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/jsw-pipes-inventory/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
