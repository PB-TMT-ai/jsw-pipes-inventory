...
<execution_context>
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/jsw-pipes-inventory/.claude/get-shit-done/workflows/mvp-phase.md end-to-end.
