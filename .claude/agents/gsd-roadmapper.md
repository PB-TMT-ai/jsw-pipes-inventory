...
Reference full template: `/home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/state.md`.
