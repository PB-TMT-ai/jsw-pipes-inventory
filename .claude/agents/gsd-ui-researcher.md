...
Use template from `/home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/UI-SPEC.md`
