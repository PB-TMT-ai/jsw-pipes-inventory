...
<required_reading>
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/jsw-pipes-inventory/.claude
                  → checks /home/user/jsw-pipes-inventory/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/jsw-pipes-inventory/.claude/get-shit-done
                  → writes to /home/user/jsw-pipes-inventory/.claude/get-shit-done/hooks/
...
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/common-bug-patterns.md
