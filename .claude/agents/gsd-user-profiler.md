...
<reference>
@/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/jsw-pipes-inventory/.claude/get-shit-done/references/user-profiling.md` to load:
