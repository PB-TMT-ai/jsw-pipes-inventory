...
```markdown
Read /home/user/jsw-pipes-inventory/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/jsw-pipes-inventory/.claude/agents/gsd-ui-checker.md for instructions.
