...
```
Agent(
  prompt="Read /home/user/jsw-pipes-inventory/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/jsw-pipes-inventory/.claude/get-shit-done/templates/VALIDATION.md`
