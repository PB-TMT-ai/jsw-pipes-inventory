...
```bash
INIT=$(node "/home/user/jsw-pipes-inventory/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/jsw-pipes-inventory/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
